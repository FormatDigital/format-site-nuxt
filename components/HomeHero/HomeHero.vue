  ...
  <section class="c-home_hero" :data-loaded="hasLoaded ? 'true' : 'false'">
    <div class="o-wrapper  o-wrapper--h">
      ...
      <div class="c-home_hero__copy o-grid">
        <p class="c-home_hero__title t-display_1  o-grid" ref="titleText" >
        ...
        <h1 class="t-heading_5 c-home_hero__sub_title" ref="subTitle">
          Format is a web design and development consultancy working with forward-thinking businesses to create engaging digital experiences.
        </h1>
...
export default {
  ...
  mounted() {
    ...
    timeline.fromTo(this.blobScale, {value: 0}, {value: 1, duration: 2, ease: "circ.out"})
            .fromTo(this.$refs.titleText.querySelectorAll('.letter'), {opacity: 0, y: 20}, {opacity: 1, y: 0, stagger: 0.05, duration: 1, ease: "power4.out"}, '0')
